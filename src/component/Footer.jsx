...
const Footer = () => {
  return (
    <footer className="bg-black text-white font-grotesk px-10 py-10 absolute bottom-0 w-full">
      <div className="grid grid-cols-3 gap-2 text-center">
        ...
        <div className="flex flex-col gap-2 text-left ml-40">
          ...
          <div className="text-[14px] hover:text-yellow-500">PRIVACY POLICY</div>
          <div className="text-[14px] hover:text-yellow-500">REFUND POLICY</div>
          <div className="text-[14px] hover:text-yellow-500">RETURN AND EXCHANGE POLICY</div>
        </div>
      </div>
    </footer>
  );
